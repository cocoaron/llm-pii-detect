...
input_path = f"./dataset/{input_json_file}" 
output_path = f"./dataset/converted_{input_json_file[:-5]}.json"

# 라벨 맵 생성
label_map = {'O': 0}
label_id = 1

print(f"BIO label conversion w/ {args.model} started")
...
print(f"BIO label conversion w/ {args.model} finished")